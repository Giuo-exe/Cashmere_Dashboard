import { Button, Card, CardActionArea, CardContent, Typography, Box, Stack, TextField, IconButton, Grid} from '@mui/material'
...
const LottoCardMiddle = ({navigazione, name, lottoid, data, cashmere, lavorata, stats, contoterzi, venditacheck, vendita, ids} : lottoCardProps) => {
    if(venditacheck) {
...
export default LottoCardMiddle